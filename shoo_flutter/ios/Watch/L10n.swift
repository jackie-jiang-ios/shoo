...
enum L10n {
    ...
    // MARK: - 购买相关
    static let upgradeToPro = tr("upgrade_to_pro")
    static let proVersion = tr("pro_version")
    static let proFeatureAllSounds = tr("pro_feature_all_sounds")
    static let proFeatureUnlockAnimals = tr("pro_feature_unlock_animals")
    static let proFeatureLifetime = tr("pro_feature_lifetime")
    static let purchaseButton = tr("purchase_button")
    static let restorePurchases = tr("restore_purchases")
    static let errorProductNotFound = tr("error_product_not_found")
    static let errorVerificationFailed = tr("error_verification_failed")
    static let errorPending = tr("error_pending")
    static let errorRestoreFailed = tr("error_restore_failed")
    static let errorSimulatorNotSupported = tr("error_simulator_not_supported")
}
